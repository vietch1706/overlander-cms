...
class AuthRegister extends AbstractAuth
{
    /**
     * @Post(
     ...
     *              @Schema(
     *                  required="user,password,password_confirmation",
     *                  @Property(property="user", ref="#/components/schemas/UserField"),
     *                  @Property(property="password", ref="#/components/schemas/PasswordField")
     *                  @Property(property="password_confirmation", ref="#/components/schemas/PasswordConfirmField")
     *              )
     *          ),
     *      ),
     *     @Response(
    ...
    public function __invoke(Request $request)
    {
        ...
        $this->userRepository->apiRegister($params);
    }
}
