...
<ul>
    <li><a href="<?= Backend::url('overlander/general/membershiptier') ?>">MembershipTier</a></li>
...
<?php if (!$this->fatalError) : ?>
    ...
    <div class="form-buttons">
        <div class="loading-indicator-container">
            ...
            <span class="btn-text">
                <?= e(trans('backend::lang.form.or')) ?> <a href="<?= Backend::url('overlander/general/membershiptier') ?>"><?= e(trans('backend::lang.form.cancel')) ?></a>
            </span>
        </div>
    </div>
    <?= Form::close() ?>
...
<?php else : ?>
    ...
    <p><a href="<?= Backend::url('overlander/general/membershiptier') ?>" class="btn btn-default"><?= e(trans('backend::lang.form.return_to_list')) ?></a></p>
<?php endif ?>
